...
Here's a rough draft that lists [descriptions for each field](https://docs.google.com/spreadsheets/d/1mrRY_sy8MmGmwzoNSexahHC54e3q-ZAy1vJl_FIsKrY/edit?gid=0#gid=0). There is a [Github issue](https://github.com/inaturalist/inaturalist/issues/3687) for the iNaturalist team to add page that describes the field.
