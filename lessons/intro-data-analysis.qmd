...
![](fig/csv_text.png){alt="screenshot of a CSV plain text file."}

CSV in CSV or spreadsheet application.

![](fig/csv_software.png){alt="screenshot of a CSV in a CSV program."}
...
2)  Geographic information system (GIS) are computer application that people can use to view, edit and analyze geographic data. The programs can do calculations and create maps. Some GIS programs can import CSVs if they have latitude and longitude fields. Examples include ArcGIS and QGIS.
