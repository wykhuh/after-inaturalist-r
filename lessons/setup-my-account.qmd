...
You can use Github Codespace to run their code online without installing stuff on their computer.
...
3.  You will be redirected to the new repository. Next step is to run the code on Codespace. Click the "Code" button, and click "Create codespace on main" button.
...
9.  The code starts with the [Working with data](working-with-data.qmd) lesson. Select a line of code, and run the code using <kbd>Cmd+Return</kbd> (Mac) or <kbd>Ctrl+Enter</kbd> (Windows).
