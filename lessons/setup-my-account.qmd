...
9.  You should read the lessons in the order they are shown in the side menu. The R lesson script files starts with the [Working with data](working-with-data.qmd) lesson. Select a line of code, and run the code using <kbd>Cmd+Return</kbd> (Mac) or <kbd>Ctrl+Enter</kbd> (Windows).
