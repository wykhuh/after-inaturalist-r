...
Functions are predefined bits of code that automate more complicated actions. Arguments are values that we pass into a function. A function takes the arguments and something to the values.
