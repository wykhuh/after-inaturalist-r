...
After the initial setup of Codespaces, you can restart Codespaces so that you can continue to code.
...
If you don't use RStudio for a few minutes, Codespace will automatically stop. You will see this error message in RStudio console:

![](images/codespace-stop/Codespace-stopped-Rstudio.png)

You will also see "Codespace is stopped" on Visual Studio Code page.

![](images/codespace-stop/Codespace-stopped.png)
