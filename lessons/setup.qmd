...
2.  You will see a "Accept the assignment" page. Click "Accept this assignment" button.
    ...
    This will create a repository in GitHub with code and data for the workshop. The repository will be created in the [{{<var classroom_organization >}}](https://github.com/orgs/{{<var classroom_organization >}}/repositories) Github account. You will save your work this repository. Only you and the workshop organizers can access your repository.
...
1.  Go to [{{<var classroom_organization >}}](https://github.com/orgs/{{<var classroom_organization >}}/repositories) account page, and you should see your repository. Click on your repository.
