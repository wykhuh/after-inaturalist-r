...
Repository is folder that has code, data, and files for a coding project. The repository also uses software called [Git](https://git-scm.com/) to keep track of file changes.
...
2.  You will see a "Accept the assignment" page. Click "Accept this assignment" button.
    ...
    This will create a repository in GitHub with code and data for the workshop. You will save your work this repository. Only you and the workshop organizers can access your repository.
