...
Go to the Visual Studio Code browser tab. Click "TERMINAL". Click "bash".

![](images/setup/bash.png)

To save the changed files to your repository, type "bash scripts/save_files.sh" in the Terminal, and hit return/enter.
...
After a little while, you will see a "Codespace is stopped" message.
