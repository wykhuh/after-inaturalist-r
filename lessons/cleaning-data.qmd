...
These are the steps we took to produced the cleaned up file. The raw file is at `data/raw/observations-512870.csv`, the cleaned file is at `data/cleaned/cnc-los-angeles-observations.csv`
...
```{r}
inat_raw <- read_csv('data/raw/observations-512870.csv')
```
...
The original dataframe 'inat_raw' had 193K rows, the cleaned dataframe 'inat' has 191K rows.
