...
Go to [{{<var classroom_organization >}}](https://github.com/orgs/%7B%7B%3Cvar%20classroom_organization%20%3E%7D%7D/repositories) account page, and you should see your repository. Click on your repository. The repository page will have a green "Code" button.
...
You can either continue to use your repository in [{{<var classroom_organization >}}](https://github.com/orgs/%7B%7B%3Cvar%20classroom_organization%20%3E%7D%7D/repositories) or you can copy to your repository to your Github account.
...
Whether you use the repo in in [{{<var classroom_organization >}}](https://github.com/orgs/%7B%7B%3Cvar%20classroom_organization%20%3E%7D%7D/repositories) or the repo in your Github account, the steps to start a Codespace is the same.
