...
Go to [`{r} classroom_organization`](`{r} classroom_repo`) account page, and you should see your repository. Click on your repository. The repository page will have a green "Code" button.
...
You can create new R projects on Github or on your computer.
