...
https://gis.data.ca.gov/datasets/California::california-county-boundaries-and-identifiers/explore
...
```{r}
st_write(la_parks_2, 'data/raw/ca_county_parks_la_county.geojson')
```
