...
Loading R packages. **sf** handles geospatial files with vector data. **mapview** creates interactive maps.
...
This data includes a `geometry` column.
...
## Observations in multiple areas

Sometimes we want to compare data in different areas of location. For instance, let's compare the number of iNaturalist observations in LA County neighborhoods.
