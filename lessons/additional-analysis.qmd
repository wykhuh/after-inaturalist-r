...
![Toby Hudson based on data from the Australian Bureau of Statistics, CC BY-SA 3.0 AU \<https://creativecommons.org/licenses/by-sa/3.0/au/deed.en\>, via Wikimedia Commons](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Australian_Census_2011_demographic_map_-_Australia_by_SLA_-_BCP_field_2715_Christianity_Anglican_Persons.svg/305px-Australian_Census_2011_demographic_map_-_Australia_by_SLA_-_BCP_field_2715_Christianity_Anglican_Persons.svg.png){fig-alt="example of choropleth map"}
...
181K out of the 191K CNC observations intersect one of the neighborhood boundaries.
