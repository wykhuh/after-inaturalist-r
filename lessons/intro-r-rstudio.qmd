...
We will use the RStudio integrated development environment (IDE) to write and run R code. RStudio includes features such as file navigation, inspecting objects, keyboard shortcuts, autocompletion of code, and syntax highlighting (different types of code are colored differently).
...
We can do comparison of price_1 and price_2
