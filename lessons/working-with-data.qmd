...
Let's get a count of how many observations have obscured locations.
...
```{r}
not_obscured <- inat_data %>%
  filter(coordinates_obscured == FALSE)  

 
summary(not_obscured$positional_accuracy)
```
